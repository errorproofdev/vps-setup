...
- All scripts use environment variables for sensitive configuration (e.g., `$SSH_HOST`, `$TS_AUTHKEY`)
...
export TS_AUTHKEY="tskey_abc123..."
...
SSH_USER="deploy"
SSH_PORT="22"
TS_AUTHKEY="tskey_..." # From Tailscale admin
